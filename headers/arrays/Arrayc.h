...
/*
*somme les elements d'une ligne ou d'une colonne de la matrice axis = 0 si l'on veut
*faire la somme des elements de d'une colonne et axis=1 si l'on veut faire la somme des 
